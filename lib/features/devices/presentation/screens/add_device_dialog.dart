...
class _WizardDialogState extends State<_WizardDialog> {
  ...
  Widget _buildContent() {
    switch (_step) {
      ...
      default:
        return _StepPlaceholderContent(step: _step);
    }
  }
}
        ...
        children: List.generate(total * 2 - 1, (i) {
          if (i.isOdd) {
            ...
            return Expanded(
              child: Container(
                height: 2,
                color: right <= current ? active : passive,
              ),
            );
          }
          final step = i ~/ 2 + 1;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            label,
            style: tt.bodySmall?.copyWith(color: Colors.black87, fontSize: 12),
          ),
          const SizedBox(height: 4),
          Text(
            title,
            style: tt.headlineMedium?.copyWith(color: const Color(0xFF2D3D2C)),
          ),
          if (subtitle != null) ...[
            const SizedBox(height: 4),
            Text(
            ...
            child: Column(
              ...
              children: [
                ...
                _Check(
                  ...
                  text: 'El ESP32 está encendido (LED azul fijo).',
                ),
                ...
                _Check(
                  ...
                  text: 'Tu computadora está en la misma red.',
                ),
              ],
            ),
          ),
...
class _Dot extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: BoxDecoration(
      ...
      boxShadow: on
          ? const [BoxShadow(color: Color(0xFF599974), blurRadius: 6)]
          : null,
    ),
  );
}
...
class _Step2State extends State<_Step2> {
  ...
  void initState() {
    super.initState();
    _pw = TextEditingController(text: widget.password);
  }
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: const Color(0xFFF5F3EF),
                    borderRadius: BorderRadius.circular(6),
                    border: Border.all(color: const Color(0xFF94BC9A)),
                  ),
                  child: Row(
                    children: [
          ...
          Expanded(
            child: Container(
              ...
              decoration: BoxDecoration(
                color: Colors.white,
                borderRadius: BorderRadius.circular(10),
                border: Border.all(color: const Color(0x4031412F)),
              ),
              child: Column(
                children: [
                  Container(
...
class _Step4State extends State<_Step4> {
  ...
  void initState() {
    super.initState();
    _nc = TextEditingController(text: widget.name);
    _lc = TextEditingController(text: widget.location);
  }
                ...
                Row(
                  children: [
                    Expanded(
                      child: _Radio(
                        label: _crops[0],
                        sel: widget.crop == _crops[0],
                        onTap: () => widget.onCrop(_crops[0]),
                      ),
                    ),
                    const SizedBox(width: 6),
                    Expanded(
                      child: _Radio(
                        label: _crops[1],
                        sel: widget.crop == _crops[1],
                        onTap: () => widget.onCrop(_crops[1]),
                      ),
                    ),
                  ],
                ),
                ...
                Row(
                  children: [
                    Expanded(
                      child: _Radio(
                        label: _crops[2],
                        sel: widget.crop == _crops[2],
                        onTap: () => widget.onCrop(_crops[2]),
                      ),
                    ),
                    const SizedBox(width: 6),
                    Expanded(
                      child: _Radio(
                        label: _crops[3],
                        sel: widget.crop == _crops[3],
                        onTap: () => widget.onCrop(_crops[3]),
                      ),
                    ),
                  ],
                ),
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Text(
          label,
          style: tt.bodySmall?.copyWith(fontSize: 10, color: Colors.black),
        ),
        const SizedBox(height: 4),
        TextField(
          controller: ctrl,
  ...
  Widget build(BuildContext context) {
    ...
    final sliders = Column(
      ...
      children: [
        ...
        const SizedBox(height: 10),
        Text(
          'Humedad mínima — alertar y regar',
          style: tt.bodySmall?.copyWith(
            fontSize: 12,
            fontStyle: FontStyle.italic,
            color: const Color(0xFF2D3D2C),
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(6),
                    border: selected
                        ? Border.all(color: const Color(0xFF94BC9A))
                        : null,
                  ),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
